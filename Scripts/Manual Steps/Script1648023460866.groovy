...
WebUI.click(findTestObject('Cura Healthcare Service Website/Appointment Page/h2_Make Appointment'))

WebUI.setText(findTestObject('Cura Healthcare Service Website/Login Page/input_Username'), 'John Doe')

WebUI.setText(findTestObject('Cura Healthcare Service Website/Login Page/input_Password'), 'ThisIsNotAPassword')
...
WebUI.click(findTestObject('Cura Healthcare Service Website/Appointment Page/span_Calendar'))
...
WebUI.verifyElementPresent(findTestObject('Cura Healthcare Service Website/Confirmation Page/h2_Appointment Confirmation'), 
    5)

WebUI.delay(4)

CustomKeywords.'keyword.sendKeys.sendkeys'()
